...
::Zi is for debug.
::NOTE: removed /Ox
cl /Zi /I..\include /I. /I..\src /I..\libs ..\src\_compiler_sources.c /link /SUBSYSTEM:console /LIBPATH:"C:\Program Files (x86)\Intel\OpenCL SDK\6.3\lib\x64" /LIBPATH:..\libs user32.lib gdi32.lib winmm.lib kernel32.lib opencl.lib advapi32.lib

popd


"C:\Program Files (x86)\Windows Kits\10\Debuggers\x64\gflags.exe" /p /enable .\build\_compiler_sources.exe
