...
::Zi is for debug.
cl /Zi /Ox /I..\include /I..\src /I..\libs ..\src\_compiler_sources.c /link /SUBSYSTEM:console /LIBPATH:"C:\Program Files (x86)\Intel\OpenCL SDK\6.3\lib\x64" /LIBPATH:..\libs user32.lib gdi32.lib winmm.lib kernel32.lib opencl.lib
